...
const productData = {
  Soap: {
    ...
    'Bartan Bar': [
      {
        name: 'Vim Bar',
        description: 'Removes grease from utensils.',
        image: 'https://via.placeholder.com/400x250?text=Vim+Bar',
        icon: <FaSoap />,
      },
      {
        name: 'Exo Bar',
        description: 'Anti-bacterial dish cleaning.',
        image: 'https://via.placeholder.com/400x250?text=Exo+Bar',
        icon: <FaSoap />,
      },
    ]
  },
  Detergent: [
    {
      ...
      image: 'https://via.placeholder.com/400x250?text=Surf+Excel',
      icon: <FaPumpSoap />,
    }
  ],
  Other: [
